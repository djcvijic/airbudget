...
- `theme.css` / `theme.js` — generic page theme and behavior (fonts, colors, buttons, back-to-top), carried over from the myvalues project.
- `main.css` / `main.js` — app-specific styling and logic.
